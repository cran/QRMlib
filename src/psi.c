...
/* Comment out inclusion of chebyshev.h since it is included in the new version of */
/* cheb_eval.c which I was forced to build (including several header files */
/* #include "chebyshev.h"   */
/* Moved cheb_eval.c into general header files since it is attached by both bessel_K0.c and bessel_I0.c */
/*  #include "cheb_eval.c"    */
/* #include <gsl/cheb_eval.c> */
